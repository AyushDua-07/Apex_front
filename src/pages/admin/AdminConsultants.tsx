                ...
                <tr key={c._id}>
                  ...
                  <td className="px-6 py-4">
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                      c.membershipPlan?.planName === 'Premium' ? 'bg-gold/20 text-yellow-800'
                      : c.membershipPlan?.planName === 'Standard' ? 'bg-blue-100 text-blue-800'
                      : 'bg-gray-100 text-gray-700'
                    }`}>
                      {c.membershipPlan?.planName || 'Basic (Default)'}
                    </span>
                  </td>
